                ...
                bool goalValue)
            {
                ...
                while (openNodes.Count > 0)
                {
                    ...
                    foreach (var action in availableActions)
                    {
                        ...
                        Dictionary<string,bool> newState = ApplyActionEffects(action, new Dictionary<string, bool>(currentNode.State));
                        ...
                        if ((IsInClosedList(closedNodes, newNode)) || IsInOpenListWithLowerCost(openNodes, newNode)) continue;
